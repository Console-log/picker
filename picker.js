;!function(win,doc){
    ...
    Picker.prototype={
        ...
        init:function(){;!function(win,doc){
    function Picker(ipt,config,callback){
        this.ipt=ipt;
        this.config={
            break:config?config.break||'-':'-',
    ...
    Picker.prototype={
        ...
        init:function(){
            ...
            this.ipt.value=this.format_date(new Date().getTime());
        ...
        format_date:function(ms){
            ...
            var _break=this.config.break;
            return date.year+_break+this.zero(date.month)+_break+this.zero(date.date);
        },
